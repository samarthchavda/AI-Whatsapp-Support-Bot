    ...
    try {
      ...
      const emailHtml = `
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>🎉 Welcome to WhatsApp Support Bot!</h1>
            </div>
            <div class="content">
              <h2>Hi ${demoRequest.name},</h2>
              <p>Great news! Your demo request has been approved. We've created your account and you can now access the WhatsApp AI Support Bot dashboard.</p>
              ...
              <p style="margin-top: 32px;">Best regards,<br><strong>WhatsApp Support Bot Team</strong></p>
            </div>
            <div class="footer">
      ...
      await transporter.sendMail({
        ...
        subject: '🎉 Your WhatsApp Support Bot Account is Ready!',
        html: emailHtml
      });
