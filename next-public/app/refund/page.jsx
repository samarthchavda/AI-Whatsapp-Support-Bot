    ...
    <div className="privacy-container">
      ...
      <main className="privacy-content">
        ...
        <section className="privacy-section-card">
          ...
          <ul>
            <li>Navigate to your merchant dashboard, open the <strong>Billing &amp; Subscriptions</strong> page, and click <strong>Cancel Subscription</strong>.</li>
            <li>Alternatively, you can send an email cancellation request to <code>hello@kwickbot.in</code> at least 48 hours before your next billing cycle.</li>
        ...
        <section className="privacy-section-card">
          ...
          <ul>
            ...
            <li><strong>First-time buyers:</strong> If you are unhappy with the software performance, first-time subscribers are eligible for a full refund within <strong>7 days of your initial payment</strong>.</li>
        ...
        <section className="privacy-section-card">
          ...
          <div className="legal-callout">
            ...
            <div>
              ...
              <p>
                Once a refund is approved by our billing support team, it is initiated instantly through our payment gateway (Razorpay). The refunded amount will be credited back to your <strong>original payment source</strong> (Credit Card, Debit Card, UPI, NetBanking, or Wallet) within <strong>5 to 7 working days</strong> depending on your bank's clearance times.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="privacy-section-card">
          ...
          <ul>
            <li>📧 Email: <strong>hello@kwickbot.in</strong> (We reply within 24 hours)</li>
            <li>📞 Phone: <strong>+91 8128420287</strong></li>
