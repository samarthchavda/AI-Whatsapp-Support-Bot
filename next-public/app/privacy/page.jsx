...
import { FaShieldAlt, FaUserShield, FaChevronLeft } from 'react-icons/fa';
  ...
  return (
    <div className="privacy-container">
      <header className="privacy-header">
        ...
        <Link href="/" className="privacy-logo" style={{ cursor: 'pointer' }}>
        ...
        <section className="privacy-section-card">
          ...
          <div className="guideline-grid">
            ...
            <div className="guideline-item">
              ...
              <p>
                Sending abandoned cart recovery reminders, discount coupons, or promotional broadcasts <strong>requires prior customer opt-in</strong>. Your storefront checkout page must have a checkbox or notice consenting to receive updates on WhatsApp.
              </p>
            </div>
          </div>
        </section>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <ul>
                    <li><strong>Service (User-initiated chat):</strong> First 1,000 conversations each month are <strong>FREE</strong>.</li>
                  ...
                  <ul style={{ marginTop: '5px', paddingLeft: '20px', listStyleType: 'circle' }}>
                    <li>
                      ...
                      <ul style={{ marginTop: '3px', paddingLeft: '15px', listStyleType: 'square' }}>
                        <li><strong>No Automated Notifications:</strong> Because the customer phone number is missing, the system <strong>cannot</strong> send automated WhatsApp confirmations, invoice bills, tracking alerts, or recovery reminders.</li>
                        <li><strong>Kwickbot Only:</strong> The merchant still gets the AI chatbot widget/live chat support, and customers can manually type in their order numbers (e.g. <code>#1008</code>) to track order status.</li>
                      </ul>
                    </li>
